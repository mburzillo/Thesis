...
tract_demo_1940$non_white_pop_1940 <- tract_demo_1940$BUQ001
...
all_holc_tract_grades_demo <- left_join(all_holc_tract_grades_1940_b, tract_demo_1940, by = c("gisjoin_1940" = "GISJOIN")) %>%
  ...
  mutate(log_contract_rent_1940 = log(median_contract_rent_1940),
         ...
         tract_area_1940 = tract_area_1940/1000,
         citypop_1930 = citypop_1930/10000)

range(all_holc_tract_grades_demo$tract_area_1940)
...
sixties$pct_owner_occupied <- 100 * sixties$owner_occupied/sixties$occupied_units


# pct renter occupied (occupied year round h units)
sixties$pct_renter_occupied <- 100 * sixties$renter_occupied/sixties$occupied_units
...
sixties <- sixties %>%
  select(gisjoin_1960:intersect_area, tot_persons_printed, pop_density:pct_plumbing_fuctional)
...
full_40_60_tract <- full_40_60 %>%
  ...
  mutate(
    ...
    pct_foreign_born_1960_in_1940 = pct_foreign_born_1960,
    pct_hs_grad_1960_in_1940 = pct_hs_grad_1960,
    pct_some_college_1960_in_1940 = pct_some_college_1960,
    weighted_tot_years_school_1960_in_1940 = weighted_tot_years_school_1960,
    pct_vacant_1960_in_1940 = pct_vacant_1960,
    pct_owner_occupied_1960_in_1940 = pct_owner_occupied_1960,
    pct_renter_occupied_1960_in_1940 = pct_renter_occupied_1960,
    pct_crowded_1960_in_1940 = pct_one_point_0_one_people_per_room_or_more_1960,
    avg_monthly_contract_rent_1960_in_1940 = avg_monthly_contract_rent_1960,
    weighted_prop_value_1960_in_1940 = weighted_prop_value_1960,
    pct_single_unit_1960_in_1940 = pct_single_unit_1960,
    pct_housing_deteriorated_dilap_1960_in_1940 = pct_housing_deteriorated_dilap_1960,
    pct_unemployed_males_1960_in_1940 = pct_unemployed_males_1960,
    pct_employed_out_of_all_males_1960_in_1940 = pct_employed_out_of_all_males_1960,
    pct_more_than_one_bathroom_1960_in_1940 = pct_more_than_one_bathroom_1960,
    pct_contract_rent_lt_50_1960_in_1940 = pct_contract_rent_lt_50_1960,
    weighted_cash_contract_rent_1960_in_1940 = weighted_cash_contract_rent_1960,
    pct_families_below_3k_income_1960_in_1940 = pct_families_below_3k_income_1960,
    weighted_family_income_1960_in_1940 = weighted_family_income_1960,
    owner_occ_property_value_1960_in_1940 = owner_occ_property_value_1960,
    avg_age_1960_in_1940 = avg_age_1960,
    avg_nunits_1960_in_1940 = avg_nunits_1960,
    pct_plumbing_fuctional_1960_in_1940 = pct_plumbing_fuctional_1960,
    pct_shared_or_no_bath_1960_in_1940 = pct_shared_or_no_bath_1960,
    pct_more_than_one_bathroom_1960_in_1940 =  pct_more_than_one_bathroom_1960,
    pct_concrete_slab_foundation_1960_in_1940 = pct_concrete_slab_foundation_1960,
    heating_pct_non_wood_burn_1960_in_1940 = heating_pct_non_wood_burn_1960,
    avg_nunits_1960_in_1940 =  avg_nunits_1960, 
    pct_built_pre_40_1960_in_1940 =  pct_built_pre_40_1960,
    log_property_value_1960_in_1940 = log_property_value_1960,
    log_contract_rent_1960_in_1940 = log_contract_rent_1960,
    log_family_income_1960_in_1940 = log_family_income_1960,
    log_property_value_1960_in_1940 = log_property_value_1960,
...
full_40_60_tract %>%
  ggplot(aes(x = median_home_value_1940)) +
  geom_histogram()
