...
data_for_analysis <- all_cities_tract_grades
...
data_for_analysis$tot_persons <- all_cities_grade_demo$B53001


# RACE from printed report (Persons)

data_for_analysis$white <- all_cities_grade_demo$B7B001
data_for_analysis$black <- all_cities_grade_demo$B7B002
data_for_analysis$other <- all_cities_grade_demo$B7B003

# total foreign stock from printed report (foreign stock persons)

data_for_analysis$foreign_stock <- all_cities_grade_demo$B7M001
...
# pct non-white
data_for_analysis$pct_non_white <- (data_for_analysis$black +
                                      data_for_analysis$other)/data_for_analysis$tot_persons * 100

# pct black
data_for_analysis$pct_black <- (data_for_analysis$black)/data_for_analysis$tot_persons * 100


# % foreign stock
data_for_analysis$pct_foreign_stock<- (data_for_analysis$foreign_stock)/data_for_analysis$tot_persons * 100
...
# need to calculate income next -> how to choose something for this??
```
