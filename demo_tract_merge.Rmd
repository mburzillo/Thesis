...
defined = c("B53001", "B7B001", "B7B002", "B7B003", "B7M001", "B8J001", "B8R001", 
            ...
            "B9V006", "B9V007", "B9Y001", "B9Y002", "B9Y003")
...
data_for_analysis  %>%
  ggplot(aes(x = pct_unemployed_males, y= prop_grade_D)) +
  geom_point() +
  geom_smooth(se = FALSE)
...
data_for_analysis <- data_for_analysis %>%
  select(NHGISST:AREANAME, tot_persons_printed:pct_more_than_one_bathroom)
