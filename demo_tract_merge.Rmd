...
# N vacant for rent (vacant year-round housing units)
data_for_analysis$vacant_for_rent_2<- all_cities_grade_demo$B9R001
# N vacant for sale (vacant year-round housing units)
data_for_analysis$vacant_for_sale_2 <- all_cities_grade_demo$B9R002
# N vacant for sale (vacant year-round housing units)
...
data_for_analysis$pct_vacant_all <- data_for_analysis$vacant_all/data_for_analysis$tot_hunits
...
data_for_analysis$pct_owner_occupied <- data_for_analysis$owner_occupied/data_for_analysis$occupied_units


# pct renter occupied (occupied year round h units)
data_for_analysis$pct_renter_occupied <- data_for_analysis$renter_occupied/data_for_analysis$occupied_units


# pct units 1.01 or more people per room (highest category)
data_for_analysis$pct_one_point_0_one_people_per_room_or_more <- data_for_analysis$persons_per_room_onepone_or_more/data_for_analysis$occupied_units
...
# remove variables that have been duplicated and renamed
