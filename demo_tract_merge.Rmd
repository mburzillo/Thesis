...
data_for_analysis$weighted_tot_years_school_1960  <- (data_for_analysis$no_school * 0 + 
                                                        data_for_analysis$school_yr_1_4 * 2.5  +
                                                        data_for_analysis$school_yr_5_7 * 6 + 
                                                        data_for_analysis$school_yr_8 * 8 + 
                                                        data_for_analysis$school_yr_hs_1_3 * 9.5 +
                                                        data_for_analysis$school_yr_hs_4 * 12 +
                                                        data_for_analysis$school_yr_college_1_3 * 13.5 +
                                                    data_for_analysis$school_yr_college_p * 16)/
  data_for_analysis$tot_school_persons
...
# calculate pct_some_college_1960
data_for_analysis$pct_some_college_1960 <- 100 * (data_for_analysis$school_yr_college_1_3 +
  data_for_analysis$school_yr_college_p) / data_for_analysis$tot_school_persons
...
data_for_analysis$weighted_family_income_1960 <- (data_for_analysis$fam_income_less_1k * 500 + 
                                                    data_for_analysis$fam_income_1_2k * 1500 + 
                                                    data_for_analysis$fam_income_2_3k * 2500 +
                                                    data_for_analysis$fam_income_3_4k * 3500 + 
                                                    data_for_analysis$fam_income_4_5k * 4500 + 
                                                    data_for_analysis$fam_income_5_6k * 5500 +
                                                    data_for_analysis$fam_income_6_7k * 6500 + 
                                                    data_for_analysis$fam_income_7_8k * 7500 + 
                                                    data_for_analysis$fam_income_8_9k * 8500 +
                                                    data_for_analysis$fam_income_9_10k * 9500 + 
                                                    data_for_analysis$fam_income_10_15k * 12500 +
                                                    data_for_analysis$fam_income_15_25k * 20000 +
                                                    data_for_analysis$fam_income_25k_p * 25000)/
  data_for_analysis$all_families_with_income_data
...
data_for_analysis$pct_employed_out_of_all_males_1960 <- 100 * data_for_analysis$employed_males/(data_for_analysis$employed_males + 
                                                                                                  data_for_analysis$unemployed_males + 
                                                                                                  data_for_analysis$armed_forces_males + 
                                                                                                  data_for_analysis$not_in_lf_males)
