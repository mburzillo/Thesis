...
# make NHGISST state and city NA for kansas city because this is a combo for KS and MO

#all_cities_grade_demo$NHGISST[all_cities_grade_demo$city == "Kansas City"] <- NA
#all_cities_grade_demo$NHGISCTY[all_cities_grade_demo$city == "Kansas City"] <- NA

# make state for Kansas City KS/MO
#all_cities_grade_demo$NHGISCTY[all_cities_grade_demo$city == "Kansas City"] <- NA
all_cities_grade_demo$citypop_total[all_cities_grade_demo$city == "Kansas City"] <- 521500
all_cities_grade_demo$state[all_cities_grade_demo$city == "Kansas City"] <- "KS/MO"
```
...
```{r}
data_for_analysis %>%
  ggplot(aes(x = pct_contract_rent_lt_50)) +
  geom_histogram()
```
