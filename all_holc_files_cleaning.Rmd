...
# add space between Fort Worth because accidentally didn't earlier
...
all_holc_tract_grades$city[all_holc_tract_grades$city == "Lake County Gary"] <- "Gary"
...
cities_to_exclude = c("Stamford, Darien, and New Canaan", "Holyoke Chicopee", "Bergen Co.", "Essex Co.", 
                      "Hudson Co.", "Union Co.", "Binghamton-Johnson City", "Lower Westchester Co.",
                      "Pawtucket and Central Falls", "Binghamton/Johnson City", "Essex County", "Hudson County")
