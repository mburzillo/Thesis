...
potential_tracts_demo <- left_join(potential_tracts, city_names_pops_1930, by = c("NAME" = "cityname", "STATE" = "state.y"))
...
```{r}
tracts_selected %>%
  group_by(NAME, STATE.y, treatment) %>%
  summarise(citypop_1930_ = mean(citypop_total_1930))
```

```{r}

list(colnames(tracts_selected))
