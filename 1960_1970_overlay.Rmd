...
prop_value_sub <- tracts_timeseries %>%
  select(holc_state:treatment, pct_black_1960, pct_owner_occupied_1960, pct_renter_occupied_1960, 
         pct_unemployed_males_1960, prop_value_owner_occ_1960, prop_value_owner_occ_1970) %>%
...
vacancy_sub <- tracts_timeseries %>%
  select(holc_state:treatment, pct_black_1960, pct_owner_occupied_1960, pct_renter_occupied_1960, 
         pct_unemployed_males_1960, pct_vacant_1960, pct_vacant_1970) %>%
...
poverty_sub <- tracts_timeseries %>%
  select(holc_state:treatment, pct_black_1960, pct_owner_occupied_1960, pct_renter_occupied_1960, 
         pct_unemployed_males_1960, pct_in_families_below_pl_1960, pct_in_families_below_pl_1970) %>%
...
fam_income_sub <- tracts_timeseries %>%
  select(holc_state:treatment, pct_black_1960, pct_owner_occupied_1960, pct_renter_occupied_1960, 
         pct_unemployed_males_1960, family_income_1960, family_income_1970) %>%
...
years_edu_sub <- tracts_timeseries %>%
  select(holc_state:treatment, pct_black_1960, pct_owner_occupied_1960, pct_renter_occupied_1960, 
         pct_unemployed_males_1960, tot_years_school_1960, tot_years_school_1970) %>%
...
hs_grad_sub <- tracts_timeseries %>%
  select(holc_state:treatment, pct_black_1960, pct_owner_occupied_1960, pct_renter_occupied_1960, 
         pct_unemployed_males_1960, pct_hs_grad_1960, pct_hs_grad_1970) %>%
...
some_college_sub <- tracts_timeseries %>%
  select(holc_state:treatment, pct_black_1960, pct_owner_occupied_1960, pct_renter_occupied_1960, 
         pct_unemployed_males_1960, pct_some_college_1960, pct_some_college_1970) %>%
...
tracts_timeseries_full <- tracts_timeseries_full[, 18:47]
